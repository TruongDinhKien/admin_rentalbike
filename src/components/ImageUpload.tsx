      ...
      <div>
        <header className="border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center">
          <p className="mb-3 font-semibold text-gray-900 flex flex-wrap justify-center">
            <span>Click on Upload a Image</span>&nbsp;
          </p>
          ...
          <div className="flex justify-center items-center mt-5 mx-3 max-w-xs">
            {preview && <img src={preview as string} alt="preview" className="w-full" />}
          </div>
        </header>
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <span>{loading ? 'Processing...' : url && 'Success'}</span>
        </div>
      </div>
    </>
  )
